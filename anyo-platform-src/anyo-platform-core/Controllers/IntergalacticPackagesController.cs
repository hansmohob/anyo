...
namespace anyo_platform_core.Controllers
{
    public class IntergalacticPackagesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PackageContents,PackageArt,PackageType,CreateDate")] IntergalacticPackages intergalacticPackages)
        {
