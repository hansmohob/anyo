...
namespace anyo_platform_core.Controllers
{
    public class IntergalacticMissionsController : Controller
    {
        ...
        // GET: IntergalacticMissions/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            ...
            intergalacticMissions.PackagesDonated = _context.IntergalacticDonation.Include(m => m.Donor).Include(m => m.Package).Where(m => m.MissionId == intergalacticMissions.Id).ToList();

            return View(intergalacticMissions);
        }

        // GET: IntergalacticMissions/Create
        ...
        // POST: IntergalacticMissions/Create
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Banner,Status,Current,Target,GroupId")] IntergalacticMissions intergalacticMissions)
        {
            ...
            {
                intergalacticMissions.CreateDate = DateTime.Now;
                intergalacticMissions.EndDate = DateTime.Now.AddDays(31);
        ...
        // GET: IntergalacticMissions/Edit/5
        ...
        // POST: IntergalacticMissions/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Banner,Status,Current,Target,GroupId,CreateDate,EndDate")] IntergalacticMissions intergalacticMissions)
        {
